        ...
        {isOpen === "CLOSED" ? (
          <View style={styles.closedContainer}>
            <Text style={styles.closedMessage}>
              Hewitt Dining Hall is currently closed.{'\n'}
